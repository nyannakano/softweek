...
<template>
    <article class="mt-16 md:mt-10 flex flex-col md:flex-row items-center justify-center text-center md:text-left">
        <img :src="image_logo_softweek" alt="Imagem do evento" class="mb-8 md:mb-0 md:mr-10">
        <div>
